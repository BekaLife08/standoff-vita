...
namespace RootMotion.Dynamics
{
	...
	public class PropRoot : MonoBehaviour
	{
		...
		private void AttachProp(Prop prop)
		{
			...
			{
				puppetMaster.AddMuscle(prop.additionalPin, prop.additionalPinTarget, prop.muscle.GetComponent<Rigidbody>(), prop.transform, new Muscle.Props(prop.additionalPinWeight, 0f, 0f, 0f, false, Muscle.Group.Prop), true);
			}
		}
	}
}
