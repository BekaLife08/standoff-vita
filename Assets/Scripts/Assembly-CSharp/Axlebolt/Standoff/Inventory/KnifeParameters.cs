...
namespace Axlebolt.Standoff.Inventory
{
	...
	public class KnifeParameters : WeaponParameters
	{
		...
		[SerializeField]
		private float _secondaryHitInterval = 0.9f;

		[SerializeField]
		private Damage _secondaryDamage;

		[SerializeField]
		private int _secondaryBackDamage = 65;
		...
		public float SecondaryHitInterval
		{
			get { return _secondaryHitInterval; }
		}
		...
		public int SecondaryBackDamage
		{
			get { return _secondaryBackDamage; }
		}
	}
}
