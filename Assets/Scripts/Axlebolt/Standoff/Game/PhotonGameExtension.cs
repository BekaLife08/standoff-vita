...
namespace Axlebolt.Standoff.Game
{
	public static class PhotonGameExtension
	{
		...
		{
			object result;
			if (player.CustomProperties.TryGetNonNullValue("team", out result))
			{
				return (Team)result;
			}
			return Team.None;
		...
		{
			object result;
			if (player.CustomProperties.TryGetNonNullValue("score", out result))
			{
				return (int)result;
			}
			return 0;
		...
		{
			object result;
			if (player.CustomProperties.TryGetNonNullValue("kills", out result))
			{
				return (int)result;
			}
			return 0;
		...
		{
			object result;
			if (player.CustomProperties.TryGetNonNullValue("round_kills", out result))
			{
				return (int)result;
			}
			return 0;
		...
		{
			object result;
			if (player.CustomProperties.TryGetNonNullValue("assists", out result))
			{
				return (int)result;
			}
			return 0;
		...
		{
			object result;
			if (player.CustomProperties.TryGetNonNullValue("round_assists", out result))
			{
				return (int)result;
			}
			return 0;
		...
		{
			object result;
			if (player.CustomProperties.TryGetNonNullValue("NextLevelVoteView", out result))
			{
		...
		{
			object result;
			if (player.CustomProperties.TryGetNonNullValue("avatar", out result))
			{
				return (byte[])result;
			}
			return null;
		...
		{
			object result;
			if (player.CustomProperties.TryGetNonNullValue("badgeId", out result))
			{
		...
		{
			object result;
			if (player.CustomProperties.TryGetNonNullValue("uid", out result))
			{
				return (string)result;
			}
			return string.Empty;
